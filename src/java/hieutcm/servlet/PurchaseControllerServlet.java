 ...
 * @author Minh Hieu
 */
@WebServlet(name = "PurchaseControllerServlet", urlPatterns = {"/PurchaseControllerServlet"})
public class PurchaseControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            log("PurchaseControllerServlet _ SQL " + ex.getMessage());
        }
        catch (NamingException ex)
        {
            log("PurchaseControllerServlet _ Naming " + ex.getMessage());
        }
        finally
        {
