...
import hieutcm.tblOrder.OrderDAO;
import hieutcm.tblOrder.OrderDTO;
import hieutcm.tblOrderDetail.OrderDetailDAO;
import hieutcm.tblOrderDetail.OrderDetailDTO;
 ...
 * @author Minh Hieu
 */
@WebServlet(name = "OrderTrackingControllerServlet", urlPatterns = {"/OrderTrackingControllerServlet"})
public class OrderTrackingControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            log("OrderTrackingControllerServlet _ SQL " + ex.getMessage());
        }
        catch (NamingException ex)
        {
            log("OrderTrackingControllerServlet _ Naming " + ex.getMessage());
        }
        finally
        {
