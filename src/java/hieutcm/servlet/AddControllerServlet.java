...
public class AddControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            if (check <=0)
            {
               ProductDTO proDTO = new ProductDTO(txtName, supID, cateID, quantity, price, img, status, isDelete, txtCreate, txtExp, cateDTO);
        ...
        {
            log("AddControllerServlet _ SQL " + ex.getMessage());
        }
        catch (NamingException ex)
        {
            log("AddControllerServlet _ Naming " + ex.getMessage());
        }
        finally
        {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AddControllerServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
