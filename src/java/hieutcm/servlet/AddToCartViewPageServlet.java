 ...
 * @author Minh Hieu
 */
@WebServlet(name = "AddToCartViewPageServlet", urlPatterns = {"/AddToCartViewPageServlet"})
public class AddToCartViewPageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            log("AddToCartViewPageServlet _ SQL " + ex.getMessage());
        }
        catch (NamingException ex)
        {
            log("AddToCartViewPageServlet _ Naming " + ex.getMessage());
        }
        finally
        {
