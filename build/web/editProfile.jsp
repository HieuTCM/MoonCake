<%-- 
    ...
    Created on : Jul 17, 2022, 10:28:37 PM
    Author     : Minh Hieu
--%>
                            ...
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input style="width: 350px;" value="${AccDTO.username}" name="txtUser"  type="text" id="inputEmail" class="form-control" readonly="">
                                    </div>
                                </div>
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                            ...
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input style="width: 350px;" value="${AccDTO.email}" name="txtEmail"  type="text" id="inputEmail" class="form-control" pattern="({0,50}" required=""
                                               title="Email in range 50 characters">
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <Strong>Your Phone : </Strong> 
                                        <input style="width: 350px;" value="${AccDTO.phone}" name="txtPhone"  type="text" id="inputEmail" class="form-control" pattern="(^0\d{9})" required
                                               title="Phone Number invalid">
                                        <button type="summit" class="btn btn-primary" name="btAction" value="UpdateProfile" style=" width: 120px;height: 40px;margin-top: 70px;;margin-left: 300px;">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
