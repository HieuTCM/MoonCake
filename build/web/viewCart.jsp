            ...
            <div class="container" style="margin: 0px 200px; padding: 0px; ">
                ...
                <c:if test="${not empty NAME}">
                    ...
                    <div class="collapse navbar-collapse">
                        ...
                        <c:if test="${role == true}">
                            <div class="collapse navbar-collapse">
                                <a href="DispatchServlet?btAction=manage" class="show-txt" color ="red">Manage Product</a>
                            </div>                            
                        </c:if>
                </c:if>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3" style="padding-left: 22px;margin-left: 30px;padding-right: 0px;">
                            <form action="DispatchServlet" method="POST">
                                ...
                                <button type="summit" class="btn btn-primary" name="btAction" value="DeleteProductFromCart" onclick="return confirm('Press OK to delete')" style="height: 40px; background-color: red;">Remove Cart</button>
                                <input type="hidden" name="txtID" value="1"/>
                                <input type="hidden" name="txtTotal" value="${requestScope.TOTAL}"/>
                                <input type="hidden" name="typrRemove" value="removeAll"/>
                            </form>		
                        </div>
                        </c:if>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <c:if test="${role != true}">
                                                        ...
                                                        <button type="summit" class="btn btn-primary" name="btAction" value="DeleteProductFromCart" onclick="return confirm('Press OK to delete')" style=" width: 70px; height: 40px;">Delete</button>
                                                        <input type="hidden" name="typrRemove" value="removeOnePro"/>
                                                    </c:if>
                                                    <c:if test="${role == true}">
                                                        ...
                                                        <button type="summit" class="btn btn-primary" name="btAction" disabled="" value="DeleteProductFromCart" onclick="return confirm('Press OK to delete')" style=" width: 70px; height: 40px;">Delete</button>
                                                        <input type="hidden" name="typrRemove" value="removeOnePro"/>
                                                    </c:if>
