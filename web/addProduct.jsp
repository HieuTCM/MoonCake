                    ...
                    <c:set var="cateDTO" value="${CATELIST}"/>
                        <div class="container" style="padding-left: 0px; padding-right: 0px; margin: 0px 200px; ">
                            ...
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <Strong class="control-label" for="datepicker-start">Create Date</Strong>
                                        <input type="date" class="form-control" width="220" value="" name="txtCreate" required>
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <Strong class="control-label" for="datepicker-end">Expiration Date</Strong>
                                         <input type="date" class="form-control" width="220" value="" name="txtExp" required>
                                    </div>
                                </div>
                            </div>
                        <button type="summit" class="btn btn-primary" name="btAction" value="Create" style=" width: 140px;height: 40px;margin-bottom: 5px;margin-left: 700px;">Create Product</button>
                        </div>
