                            ...
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input type="date" class="form-control" width="276" value="${proDTO.craeteDate}" name="txtCreate" required>
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <Strong class="control-label" for="datepicker-end">Expiration Date</Strong>
                                         <input type="date" class="form-control" width="276" value="${proDTO.expirationDate}" name="txtExp" required>
                                    </div>
                                </div>
                            </div>
