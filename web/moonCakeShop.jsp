...
<%@page import="hieutcm.tblCategory.CategoryDAO"%>
<%@page import="hieutcm.tblCategory.CategoryDTO"%>
<%@page import="hieutcm.tblProduct.ProductDAO"%>
<%@page import="java.util.List"%>
<%@page import="hieutcm.tblProduct.ProductDTO"%>
...
<html>
    <head>
        ...
        <title>Half Moon Shop</title>
    </head>
    <body>
        <nav class="navbar navbar-expand-md navbar-dark bg-dark" >
            <div class="container" style="margin: 0px 200px; padding: 0px; ">
                <a class="navbar-brand" href="DispatchServlet">Moon Cake Shop</a>
                ...
                <c:if test="${not empty NAME}">
                    ...
                    <div class="collapse navbar-collapse">
                        ...
                        <a href="UpdateInforControllerServlet" class="show-txt" color ="red" style="color :greenyellow; margin-right: 30px;">Profile</a>
                        <a href="LogoutServlet" class="show-txt" color ="red">Logout</a>
                    </div>
                        <c:set var="role" value="${sessionScope.AccDTO.role}"/>
                        <c:if test="${role == true}">
                            <div class="collapse navbar-collapse">
                                <a href="DispatchServlet?btAction=manage" class="show-txt" style="width:150px; margin-left: 10px; ">Manage Product</a>
                            </div>                            
                        </c:if>
                </c:if>
                <c:if test="${empty NAME}">
                    <div class="collapse navbar-collapse">
                        ...
                        <button style="margin-left: 5px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#Mymodal2">Register</button>
                        <!-- .Launch Modal Button-->
                    </div>
                    <!-- .modal -->
                            ...
                            <div class="modal-content">
                                ...
                                <form action="DispatchServlet" method="POST" class="form-signin" >
                                    <div class="modal-body">
                                        ...
                                        <input style="margin-bottom: 5px;" name="txtUserName"  type="text" id="inputEmail" class="form-control" placeholder="Username" required="" autofocus="">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="DispatchServlet" method="POST" class="form-signin" >
                                    <div class="modal-body">
                                        ...
                                        <input style="margin-bottom: 5px;" name="txtUserName"  type="text" id="inputEmail" class="form-control" placeholder="Username" required="" autofocus="">
                                        <input style="margin-bottom: 5px;" name="txtPassword"  type="password" id="inputPassword" class="form-control" placeholder="Password" required="">
                                        <input style="margin-bottom: 5px;" name="txtFulname"  type="text" id="inputEmail" class="form-control" placeholder="Full Name" required="" pattern="([a-zA-Z\s]){0,50}" title="Name Without Special Characters and in range 50 characters">
                                        <input style="margin-bottom: 5px;" name="txtEmail"  type="text" id="inputEmail" class="form-control" placeholder="Email" required="">
                                        <input name="txtPhone"  type="text" id="inputEmail" class="form-control" placeholder="Phone Number" required="" pattern="(^0\d{9})" title="Phone must have 10 digit and begin wwith 0">
                                    </div>   
                                    <div class="modal-footer">
                                        <button class="btn btn-primary btn-block" type="submit" name="btAction" value="Register">Register</button>
                                    </div>
                                </form>
                            </div>                                                                       
                        </div>                                      
        ...
        <c:if test="${not empty REGISTER2}">
            <div class="row">
                <div class="col">
                    <div class="alert success" role="alert" style="padding:0px; padding-bottom: 3px;">
                        <div class="col">
                            <strong>Register Fail!</strong>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="padding-left: 100px;">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9" style="margin-bottom: 830px;">
                        ...
                        <c:if test="${note != notFound}">
                                                ...
                                                <div class="card-body">
                                                    <h4 class="card-title show-txt">
                                                        ...
                                                        <input type="hidden" value="${proDTO.proID}" name="txtProID" />
                                                            <a href="DispatchServlet?btAction=detail&proID=${proDTO.proID}" title="View Product">${proDTO.cate.cateName}</a>
                                                    </h4>
                            ...
                            <ul class="pagination justify-content-center" style="margin-left: 572px;">
                                <c:set var="cateList" value="${requestScope.CATELIST}"/>
                                <c:if test="${not empty param.cateID}">
                                    <c:set var="page" value="1"/>
